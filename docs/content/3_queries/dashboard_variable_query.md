...
By default measurements of all datatypes are accessible to query, you can select one or more datatypes to filter on.
...
You can toggle `Use asset path` to use the asset path instead of the asset name when displaying the asset in the dashboard variable dropdown.
