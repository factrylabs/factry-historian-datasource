 ...
 *
 * A leaf keeps the rows whose column holds any of Values under the "in" operator, where a
 * null among them matches a cell that is not filled in and an empty list matches no rows at
 * all; "isEmpty" and "isNotEmpty" read whether the cell is filled in and take no values.
 */
